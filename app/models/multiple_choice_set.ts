...
export default class MultipleChoiceSet extends BaseModel {
  ...
  @hasMany(() => MultipleChoiceQuestion)
  declare multipleChoiceQuestions: HasMany<typeof MultipleChoiceQuestion>

  @manyToMany(() => LibraryItem, {
    pivotTable: 'multiple_choice_set_library_items',
    pivotTimestamps: true,
  })
  declare libraryItems: ManyToMany<typeof LibraryItem>

  @manyToMany(() => Note, {
    pivotTable: 'multiple_choice_set_notes',
    pivotTimestamps: true,
  })
